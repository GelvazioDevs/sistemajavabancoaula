...
public class ManipTXT {
    ...
    public boolean ValidaData(String Data)
        ...
        try {
            ...
            if ((Integer.valueOf(dia)).intValue() != (Integer.valueOf(cal.get(Calendar.DAY_OF_MONTH))).intValue()) {
                return (false);
            } else if ((Integer.valueOf(mes)).intValue() != (Integer.valueOf(cal.get(Calendar.MONTH) + 1)).intValue()) {
                return (false);
            } else if ((Integer.valueOf(ano)).intValue() != (Integer.valueOf(cal.get(Calendar.YEAR))).intValue()) {
                return (false);
            }
            return (true);
